...
class XueshuSpider(scrapy.Spider):
    ...
    allowed_domains = ['cdmd.cnki.com.cn', 'xueshu.baidu.com']
    baidu_xueshu_page = 0
    ...
    def parse(self, response):
        ...
        for post_node in post_nodes:
            ...
            publication = info_div.css('span:nth-child(2) a::text').extract_first('None').strip()
            date_year = info_div.css('span:nth-child(3)::text').extract_first('None').strip()
    ...
    def parse_detail(self, response):
        ...
        if site == '知网空间':
            ...
            item_loader.add_css('organization', 'div.xx_font:nth-child(5)::text[1]')
